...
?>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1s">
                    <div class="tf__about_us_img">
                        <div class="img">
                            <img src="images/about-bg.jpeg" alt="about us" class="img-fluid w-100">
                        </div>
    ...
    <section class="tf__mission mt_100 xs_mt_70" style="background: url(images/cater.jpeg);">
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-5 wow fadeInRight" data-wow-duration="1s">
                    <div class="tf__about_choose_img">
                        <img src="images/choose-us.jpeg" alt="about us" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
